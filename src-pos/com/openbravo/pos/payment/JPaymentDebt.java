...
/*
 * 12-09-2014 JOSE DE PAZ JDP REQ140914 Se valida que el CUPO alcance para el débito
 * 16-09-2014 JOSE DE PAZ JDP REQ140914 Agregar propiedad del CUPO restante.
 */

public class JPaymentDebt extends javax.swing.JPanel implements
		JPaymentInterface {
	...
	private Boolean bAlcanza = false;
	private double dSaldoCupo=0.0;
	...
	public JPaymentDebt(JPaymentNotifier notifier) {
		...
		m_jTendered
				.addPropertyChangeListener("Edition", new RecalculateState());
	...
	public void activate(CustomerInfoExt customerext, double dTotal) {
		...
		if (customerext == null) {
			...
			txtCupArtEsp.setText(null); /*18/12/2014 JDP*/
			...
			txtMaxdebt.setText(Formats.CURRENCY.formatValue(customerext
					.getMaxdebt()));
			txtCurdate.setText(Formats.DATE.formatValue(customerext
					.getCurdate()));
			txtCurdebt.setText(Formats.CURRENCY.formatValue(customerext
					.getCurdebt()));
			txtCupArtEsp.setText(Formats.CURRENCY.formatValue(customerext
					.getCupArtEsp())); /*18/12/2014 JDP*/
			...
			/*12-09-2014  JDP*/
			if (customerext.getCurdebt() != null) {

				if (customerext.getMaxdebt() >= (customerext.getCurdebt() + dTotal)) {
					this.bAlcanza = true;
				} else {
					this.bAlcanza = false;
				}
				dSaldoCupo=customerext.getMaxdebt()-customerext.getCurdebt();
			}
			else
			{
				if (customerext.getMaxdebt()>0)
				{
					if (customerext.getMaxdebt() >=  dTotal) {
						this.bAlcanza = true;
					} else {
						this.bAlcanza = false;
					}
					dSaldoCupo=customerext.getMaxdebt();
				}
			}
			/*12-09-2014*/			
		}
	...
	private void printState() {
		...
		if (customerext == null) {
			...
			m_jMoneyEuros.setText(Formats.CURRENCY.formatValue(new Double(
					m_dPaid)));
	...
	private void initComponents() {
		...
		m_jCupArtEsp = new javax.swing.JLabel();
		...
		jPanel4.add(m_jName);
		m_jName.setBounds(130, 70, 200, 19);
		...
		jPanel4.add(jLabel2);
		jLabel2.setBounds(20, 180, 140, 15);

		txtMaxdebt.setEditable(false);
		txtMaxdebt.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
		jPanel4.add(txtMaxdebt);
		txtMaxdebt.setBounds(160, 180, 130, 19);

		m_jCupArtEsp.setText(AppLocal.getIntString("Label.CupArtEsp")); // NOI18N
		jPanel4.add(m_jCupArtEsp);
		m_jCupArtEsp.setBounds(20, 210, 140, 15);

		txtCupArtEsp.setEditable(false);
		txtCupArtEsp.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
		jPanel4.add(txtCupArtEsp);
		txtCupArtEsp.setBounds(160, 210, 130, 19);
		...
		txtCurdebt.setBounds(160, 240, 130, 19);

		jLabel6.setText(AppLocal.getIntString("label.curdate")); // NOI18N
		jPanel4.add(jLabel6);
		jLabel6.setBounds(20, 270, 140, 15);

		txtCurdate.setEditable(false);
		txtCurdate.setHorizontalAlignment(javax.swing.JTextField.CENTER);
		jPanel4.add(txtCurdate);
		txtCurdate.setBounds(160, 270, 130, 19);
	...
	private javax.swing.JLabel m_jCupArtEsp;
