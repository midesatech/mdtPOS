 ...
 * **************************************************************************************************
 * 07/07/2016    D001      JOSE DE PAZ         Add new PaymentRefundCreator for Venta Credito
 * 
 * 
 * 
 */
...
public class JPaymentSelectRefund extends JPaymentSelect {
    ...
    protected void addTabs() {
        ...
        addTabPayment(new JPaymentSelect.JPaymentValeCompassRefundCreator());
        addTabPayment(new JPaymentSelect.JPaymentPostPagoDescNomRefundCreator());
        addTabPayment(new JPaymentSelect.JPaymentPrepagoSobreCupoRefundCreator());
        addTabPayment(new JPaymentSelect.JPaymentPrepagoRefundCreator());
        addTabPayment(new JPaymentSelect.JPaymentVentaCreditoRefundCreator()); // 9
