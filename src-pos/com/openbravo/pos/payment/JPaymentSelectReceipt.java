 ...
 * **************************************************************************************************
 * 07/07/2016    D001      JOSE DE PAZ         Add new PaymentCreator for Venta Credito
 * 
 * 
 * 
 */
...
public class JPaymentSelectReceipt extends JPaymentSelect {
    ...
    protected void addTabs() {
        ...
        addTabPayment(new JPaymentSelect.JPaymentValeCompassCreator());        
        addTabPayment(new JPaymentSelect.JPaymentPostPagoDescNomCreator());
        addTabPayment(new JPaymentSelect.JPaymentPrepagoSobreCupoCreator());
        addTabPayment(new JPaymentSelect.JPaymentPrepagoCreator());
        addTabPayment(new JPaymentSelect.JPaymentVentaCreditoCreator()); // 11
