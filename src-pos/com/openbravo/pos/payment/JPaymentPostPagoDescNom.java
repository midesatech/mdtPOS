 ...
 * **************************************************************************************************
 * 07/07/2016    D001      JOSE DE PAZ         Sale must be closed if there is a CUSTOMER selected.
 * 
 * 
 * 
 */
...
public class JPaymentPostPagoDescNom  extends javax.swing.JPanel implements JPaymentInterface {
    
    /**
	 * 
	 */
	private static final long serialVersionUID = -428697458172920632L;
...
//    private double m_dPaid;
    ...
    /** Creates new form JPaymentPostPagoDescNom */
    public JPaymentPostPagoDescNom(JPaymentNotifier notifier) {
...
//        
//        String code = dlSystem.getResourceAsXML("payment.postpagodesnom");
//        if (code != null) {
//            try {
...
//        
    ...
    public PaymentInfo executePayment() {
        /*if (m_dPaid - m_dTotal >= 0.0) {
    	 ...
    	 //return new PaymentInfoTicket(m_dPaid, "postpagodesnom");
...
//        m_notifier.setStatus(m_dPaid > 0.0, iCompare >= 0);
    ...
    public class ScriptPaymentCash {
        ...
        public ScriptPaymentCash(DataLogicSystem dlSystem) {
            ...
            tnbbutton = new ThumbNailBuilder(64, 54, "com/openbravo/images/.png");
        }
