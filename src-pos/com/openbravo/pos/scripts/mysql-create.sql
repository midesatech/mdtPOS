...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('30', 'Printer.Recarga', 0, $FILE{/com/openbravo/pos/templates/Printer.Recarga.XML});
...
CREATE UNIQUE INDEX CENTROCOSTO_NAME_INX ON CENTROCOSTO(NAME);
...
CREATE TABLE SUBCENTROCOSTO (
    ...
    NAME VARCHAR(255) NOT NULL,
	ESTADO BIT NOT NULL,
    CCOSTOID VARCHAR(255),   
    PRIMARY KEY(ID),
    CONSTRAINT SUBCOSTO_FK_1 FOREIGN KEY (CCOSTOID) REFERENCES CENTROCOSTO(ID)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 ;
CREATE UNIQUE INDEX SUBCENTROCOSTO_NAME_INX ON SUBCENTROCOSTO(NAME);
...
CREATE UNIQUE INDEX TIPOCUENTA_NAME_INX ON CENTROCOSTO(NAME);
INSERT INTO TIPOCUENTA (ID,NAME) VALUES ('0','POSPAGO DESC X NOMINA');
INSERT INTO TIPOCUENTA (ID,NAME) VALUES ('1','PREPAGO CON SOBRECUPO');
INSERT INTO TIPOCUENTA (ID,NAME) VALUES ('2','PREPAGO');
...
CREATE TABLE CUSTOMERS (
    ...
    PRIMARY KEY (ID),
    CCOSTOID VARCHAR(255),
	SUBCCOSTOID VARCHAR(255),
	SOBRECUPO BIT NOT NULL,
	TIPOCUENTAID VARCHAR(255),
	CORELE VARCHAR(255),
	CELCON VARCHAR(255),
	NOMCON VARCHAR(255),
	CUPARTESP DOUBLE DEFAULT 0,
	CONCUPCLI DOUBLE DEFAULT 0,
	CONARTESP DOUBLE DEFAULT 0,	
	IMAGE MEDIUMBLOB,
	APLICAIVA BIT NOT NULL,
	CUPOAUTO  DOUBLE DEFAULT 0,
	CONSTRAINT CCOSTO_FK_1 FOREIGN KEY (CCOSTOID) REFERENCES CENTROCOSTO(ID),
	CONSTRAINT CCOSTO_FK_2 FOREIGN KEY (SUBCCOSTOID) REFERENCES SUBCENTROCOSTO(ID)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE PRODUCTS (
    ...
    ISARTESP BIT DEFAULT 0,
    PRICESELL2 DOUBLE NOT NULL,
    PRICESELL3 DOUBLE NOT NULL,
    PRICESELL4 DOUBLE NOT NULL,
    NOMOSIVA BIT DEFAULT 0,
    PRIMARY KEY (ID),
...
CREATE TABLE CLOSEDCASH (
    ...
    DATEEND DATETIME,
	CLOSEDID INTEGER NOT NULL default 0,
    PRIMARY KEY(MONEY)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE RECARGA (
 ...
 TIPOCUPO VARCHAR(25) NOT NULL,
 IDCUSTOMER VARCHAR(255) NOT NULL,
 VALOR DOUBLE,
 NUMCONSIGNACION VARCHAR(255),
 TIPOPAGORECID VARCHAR(255)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
CREATE INDEX RECARGA_INX_1 ON RECARGA(ID);

CREATE TABLE RECARGANUM (ID INTEGER NOT NULL);  
INSERT INTO  RECARGANUM VALUES(0);


CREATE TABLE TIPOCUPO (
    ID VARCHAR(255) NOT NULL,
    NAME VARCHAR(255) NOT NULL,   
    PRIMARY KEY (ID)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
CREATE UNIQUE INDEX TIPOCUPO_NAME_INX ON TIPOCUPO(NAME);
INSERT INTO TIPOCUPO(ID, NAME) VALUES ('1', 'Cupo Cliente' );
INSERT INTO TIPOCUPO(ID, NAME) VALUES ('2', 'Cupo Articulo Especial' );

CREATE TABLE TIPOPAGORECARGA (
  ID varchar(255) NOT NULL,
  NAME varchar(255) NOT NULL,
  PRIMARY KEY (ID),
  UNIQUE KEY TIPOPAGORECAARGA_NAME_INX (NAME)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO TIPOPAGORECARGA(ID, NAME) VALUES ('1', 'Efectivo' );
INSERT INTO TIPOPAGORECARGA(ID, NAME) VALUES ('2', 'Consignacion' );

CREATE TABLE TICKETNUMSV (ID INTEGER NOT NULL);  
INSERT INTO  TICKETNUMSV VALUES(999);

CREATE TABLE TIPOPAGOPAYMENTS (
  ID varchar(255) NOT NULL,
  NAME varchar(255) NOT NULL,
  PRIMARY KEY (ID),
  UNIQUE KEY TIPOPAGOPAYMENTS_NAME_INX (NAME)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO TIPOPAGOPAYMENTS(ID, NAME) VALUES ('cash', 'EFECTIVO' );
INSERT INTO TIPOPAGOPAYMENTS(ID, NAME) VALUES ('valecompass', 'VALE COMPASS' );
INSERT INTO TIPOPAGOPAYMENTS(ID, NAME) VALUES ('free', 'GRATIS' );
INSERT INTO TIPOPAGOPAYMENTS(ID, NAME) VALUES ('cheque', 'CHEQUE' );
INSERT INTO TIPOPAGOPAYMENTS(ID, NAME) VALUES ('magcard', 'T. CREDITO' );
INSERT INTO TIPOPAGOPAYMENTS(ID, NAME) VALUES ('paperin', 'NOTA' );
INSERT INTO TIPOPAGOPAYMENTS(ID, NAME) VALUES ('debt', 'DEBITO' );
INSERT INTO TIPOPAGOPAYMENTS(ID, NAME) VALUES ('postpagodesnom', 'POSPAGO DESC NOM' );
INSERT INTO TIPOPAGOPAYMENTS(ID, NAME) VALUES ('prepagosobrecupo', 'PREPAGO SOBRE CUPO' );
INSERT INTO TIPOPAGOPAYMENTS(ID, NAME) VALUES ('prepago', 'PREPAGO' );
INSERT INTO TIPOPAGOPAYMENTS(ID, NAME) VALUES ('ventacredito', 'VENTAS CREDITO' );
...
--  NAME VARCHAR(255) NOT NULL,
--  DATE DATETIME NOT NULL,
-- CONSTRAINT OPENDWR_FK_1 FOREIGN KEY (ID) REFERENCES PEOPLE(ID)
--) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--26/JUN/2017
--RECARGA CUPO AUTOMATICO POR FECHA
 CREATE TABLE RECARGACUPOPARAM (
  ID      VARCHAR(255) NOT NULL,
  FECHA   DATETIME NOT NULL,
  VALOR   DOUBLE NOT NULL,
  ACTIVO  BIT NOT NULL DEFAULT 1,
  PRIMARY KEY (ID),
  UNIQUE  KEY RECARGACUPOPARAM_NAME_INX (FECHA)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


--REGISTRO DE ALERTA DE PRODUCTOS CUANDO SE REALIZA LA VENTA
 
 CREATE TABLE ALERTAPRODUCTOS (
  ID_CUS VARCHAR(255) NOT NULL,
  ID_PRO VARCHAR(255) NOT NULL,
  ID_LOC VARCHAR(255) NOT NULL,
  BLOQUE BIT NOT NULL DEFAULT 0,
  VTALIM BIT NOT NULL DEFAULT 0,
  MAXIMO INTEGER DEFAULT 0,
  PRIMARY KEY (ID_CUS, ID_PRO, ID_LOC)  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
