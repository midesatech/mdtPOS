...
public class JParamsTipoCuenta extends javax.swing.JPanel implements
		ReportEditorCreator {
	...
	public void init(AppView app) {
		...
		m_sentlocations = dlSales.getTipoCuentaList();
	...
	private void initComponents() {
		...
		setBorder(javax.swing.BorderFactory.createTitledBorder(AppLocal.getIntString("Label.PorTipCue"))); // NOI18N
		setPreferredSize(new java.awt.Dimension(400, 50));
		setLayout(null);
		add(m_jLocation);
		m_jLocation.setBounds(161, 20, 220, 20);

		jLabel8.setText(AppLocal.getIntString("Label.TipCue")); // NOI18N
		add(jLabel8);
