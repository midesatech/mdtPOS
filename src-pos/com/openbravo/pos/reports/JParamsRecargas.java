 ...
 * @author adrianromero
 */
public class JParamsRecargas extends javax.swing.JPanel implements
		ReportEditorCreator {
	...
	public void init(AppView app) {
		...
		m_sentlocations = dlSales.getTipoCupoList();
	...
	private void initComponents() {
		...
		setBorder(javax.swing.BorderFactory.createTitledBorder("Cupos")); // NOI18N
		setPreferredSize(new java.awt.Dimension(400, 60));
		setLayout(null);
		add(m_jLocation);
		m_jLocation.setBounds(161, 20, 220, 20);

		jLabel8.setText("Cupo"); // NOI18N
		add(jLabel8);
