...
import com.openbravo.pos.customers.JCustomerFindeTarjeta;
...
public class JParamsCustomerPer extends javax.swing.JPanel implements ReportEditorCreator {
    
    private DataLogicCustomers dlCustomers;
    private CustomerInfo currentcustomer;
    
    /** Creates new form JParamsCustomer */
    public JParamsCustomerPer() {
    ...
    private void initComponents() {
       ...
       // lblTarjeta.setText(AppLocal.getIntString("label.cardnumber")); // NOI18N
       // add(lblTarjeta);
       // lblTarjeta.setBounds(20, 50, 70, 14);
       // add(txtTarjeta);
       // txtTarjeta.setBounds(160, 50, 210, 20);
    ...
    private void btnCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCustomerActionPerformed
        ...
        JCustomerFindeTarjeta finder = JCustomerFindeTarjeta.getCustomerFinder(this, dlCustomers);
