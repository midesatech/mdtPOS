...
public class JParamsDatesIntervalP extends javax.swing.JPanel implements ReportEditorCreator {

    /** Creates new form JParamsClosedPos */
    public JParamsDatesIntervalP() {
        initComponents();
    }
    
    public void setStartDate(Date d) {
    	 Formats formato = Formats.DATE;
    	    formato.setDateTimePattern("");
    ...
    Formats formato = Formats.DATE;
    formato.setDateTimePattern("yyyy/MM/dd");
    	
    	
    	
    	
        Object startdate = formato.parseValue(jTxtStartDate.getText());
        Object enddate = formato.parseValue(jTxtEndDate.getText());
