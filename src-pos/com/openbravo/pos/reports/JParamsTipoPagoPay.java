...
public class JParamsTipoPagoPay extends javax.swing.JPanel implements
		ReportEditorCreator {
	...
	public void init(AppView app) {
		...
		m_sentlocations = dlSales.getTipoPagoPaymentsList();
	...
	private void initComponents() {
		...
		setBorder(javax.swing.BorderFactory.createTitledBorder(AppLocal
				.getIntString("Label.PorFormaPago"))); // NOI18N
		setPreferredSize(new java.awt.Dimension(400, 50));
		setLayout(null);
		add(m_jLocation);
		m_jLocation.setBounds(161, 20, 220, 20);

		jLabel8.setText(AppLocal.getIntString("Label.FormaPago")); // NOI18N
		add(jLabel8);
