...
public class ProductsEditor extends JPanel implements EditorRecord {
    ...
    public ProductsEditor(DataLogicSales dlSales, DirtyManager dirty) {
        ...
        m_jCArtEsp.addActionListener(dirty);
        ...
        m_jPriceSell2.getDocument().addDocumentListener(new PriceManager());
        m_jPriceSell3.getDocument().addDocumentListener(new PriceManager());
        m_jPriceSell4.getDocument().addDocumentListener(new PriceManager());
        
        m_jCMosIva.addActionListener(dirty);
...
//        m_dUnits = null;
    ...
    public void writeValueDelete(Object value) {
        ...
        m_dPriceSell2 = (Double) myprod[17];
        m_dPriceSell3 = (Double) myprod[18];
        m_dPriceSell4 = (Double) myprod[19];
        m_bPriceSellLock = true;
        m_jPriceSell.setText(Formats.CURRENCY.formatValue(m_dPriceSell));  
        m_jPriceSell2.setText(Formats.CURRENCY.formatValue(m_dPriceSell2));
        m_jPriceSell3.setText(Formats.CURRENCY.formatValue(m_dPriceSell3));
        m_jPriceSell4.setText(Formats.CURRENCY.formatValue(m_dPriceSell4));
        m_bPriceSellLock = false;
        ...
        m_jBreakdown.setSelected(false);
        m_jCArtEsp.setSelected(((Boolean)myprod[16]).booleanValue());
       
        m_jCMosIva.setSelected(((Boolean)myprod[20]).booleanValue());
    ...
    public Object createValue() throws BasicException {
        Object[] myprod = new Object[21 + (m_matlist.size() * 2) +1];
        ...
        myprod[16] = Boolean.valueOf(m_jCArtEsp.isSelected());
        myprod[17] = m_dPriceSell2;
        myprod[18] = m_dPriceSell3;
        myprod[19] = m_dPriceSell4;
        myprod[20] = Boolean.valueOf(m_jCMosIva.isSelected());
        
        //Añadimos los datos de los materiales
        int i = 21; //Por cada campor en PRODUCTOS se debe aumentar este valor
    ...
    private class PriceManager implements DocumentListener  {
        public void changedUpdate(DocumentEvent e) {
            if (!m_bPriceSellLock) { // veo si puedo tocar m_jPriceSell
                ...
                m_dPriceSell2 = readCurrency(m_jPriceSell2.getText());
                m_dPriceSell3 = readCurrency(m_jPriceSell3.getText());
                m_dPriceSell4 = readCurrency(m_jPriceSell4.getText());
    ...
    private void initComponents() {
        ...
        m_jArtEsp = new javax.swing.JLabel();
        m_jCArtEsp = new javax.swing.JCheckBox();
        
        m_jPanelPrecios = new javax.swing.JPanel();
        lblPrecio2 = new javax.swing.JLabel(AppLocal.getIntString("Label.Precio2"));
        lblPrecio3 = new javax.swing.JLabel(AppLocal.getIntString("Label.Precio3"));
        lblPrecio4 = new javax.swing.JLabel(AppLocal.getIntString("Label.Precio4"));
        m_jPriceSell2 = new javax.swing.JTextField(); 
        m_jPriceSell3 = new javax.swing.JTextField(); 
        m_jPriceSell4 = new javax.swing.JTextField(); 
        
        m_jMosIva = new javax.swing.JLabel();
        m_jCMosIva = new javax.swing.JCheckBox();
        ...
        /*18-12-2014  JDP*/
        m_jArtEsp.setText("Articulo Especial"); // NOI18N
        jPanel2.add(m_jArtEsp);
        m_jArtEsp.setBounds(10, 200, 110, 22);
        jPanel2.add(m_jCArtEsp);
        m_jCArtEsp.setBounds(160, 200, 80, 22);
        ...
        /* 16/08/2017 */
        m_jMosIva.setText("No mostrar IVA"); // NOI18N
        jPanel2.add(m_jMosIva);
        m_jMosIva.setBounds(250, 20, 110, 22);
        jPanel2.add(m_jCMosIva);
        m_jCMosIva.setBounds(375, 20, 50, 22);
        ...
        //m_jPanelPrecios.setBorder(null);
        m_jPanelPrecios.setLayout(null);
        
       
        m_jPanelPrecios.add(lblPrecio2);
        lblPrecio2.setBounds(10, 10, 150, 17);
        m_jPriceSell2.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        m_jPanelPrecios.add(m_jPriceSell2);
        m_jPriceSell2.setBounds(160, 10, 80, 20);
        
        m_jPanelPrecios.add(lblPrecio3);
        lblPrecio3.setBounds(10, 40, 150, 17);
        m_jPriceSell3.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        m_jPanelPrecios.add(m_jPriceSell3);
        m_jPriceSell3.setBounds(160, 40, 80, 20);

        m_jPanelPrecios.add(lblPrecio4);
        lblPrecio4.setBounds(10, 70, 150, 17);
        m_jPriceSell4.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        m_jPanelPrecios.add(m_jPriceSell4);
        m_jPriceSell4.setBounds(160, 70, 80, 20);
        
        
        jTabbedPane1.addTab("", m_jPanelPrecios);
    ...
    private void m_jBreakdownStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_m_jBreakdownStateChanged
        if (m_jBreakdown.isSelected()) {
            ...
            {
            	if (!jTabbedPane1.getTitleAt(3).equals(""))
    ...
    private javax.swing.JLabel m_jArtEsp;
    private javax.swing.JCheckBox m_jCArtEsp;
    // End of variables declaration//GEN-END:variables
    
    private javax.swing.JPanel m_jPanelPrecios;
    ...
    private javax.swing.JLabel m_jMosIva;
    private javax.swing.JCheckBox m_jCMosIva;
