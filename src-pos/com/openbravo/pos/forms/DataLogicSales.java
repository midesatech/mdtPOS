...
//    These modifications are copyright Open Sistemas de InformaciÃ³n Internet, S.L.
...
//    25/08/2017 V. 1.3.34-1  JDP001 Corrección BUG cuando el usuario edita ticket con número
...
//TODO: Â¿Se necesita crear una clase para ello?
    ...
    /**
     * Carga tickets para edición  JDP001
     * @param ticketid
     * @return
    ...
    public AlertaProductosInfo getAlertaProducto(AlertaProductosInfo param, String money) throws BasicException  {
    	...
    	if (ret!=null)
    	{
    		...
    		{ 
    			...
    			//Si es diferente a null es porque encontró ventas dentro del cierre de caja actual.
    			if (oProdVend!=null)
    			{
