...
public class DataLogicSystem extends BeanFactoryDataSingle {
    ...
    /* 11/Jun/2016 */
    protected SentenceFind m_HistoricCash;
    ...
    public void init(Session s){
        ...
        m_HistoricCash = new StaticSentence(s
                , "SELECT MONEY, HOST, DATESTART, DATEEND FROM CLOSEDCASH WHERE CLOSEDID = ?"
                , SerializerWriteInteger.INSTANCE
                , new SerializerReadBasic(new Datas[] {Datas.STRING, Datas.STRING, Datas.TIMESTAMP, Datas.TIMESTAMP}));
...
//    public abstract BaseSentence getShutdown();
    ...
    public final Object[] finHistoricCash(int iConsecutivoCashIndex) throws BasicException {
        return (Object[]) m_HistoricCash.find(iConsecutivoCashIndex);
    }
