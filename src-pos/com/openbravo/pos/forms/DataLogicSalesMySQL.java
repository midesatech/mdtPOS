...
public class DataLogicSalesMySQL extends DataLogicSales {
	...
	public final Integer getNextClosedCashIndex() throws BasicException {
        return (Integer) new SequenceForMySQL(s, "CLOSEDCASHNUM", SerializerReadInteger.INSTANCE).find();
    }
	/*30/12/2014 JDP*/
	public final Integer getNextRecargaIndex() throws BasicException {
        return (Integer) new SequenceForMySQL(s, "RECARGANUM", SerializerReadInteger.INSTANCE).find();
    }	
	
	public final Integer getNextTicketNumSVIndex() throws BasicException {
        return (Integer) new SequenceForMySQL(s, "TICKETNUMSV", SerializerReadInteger.INSTANCE).find();
    }	
}