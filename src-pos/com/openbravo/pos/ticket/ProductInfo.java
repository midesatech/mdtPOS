...
public class ProductInfo implements SerializableRead, IKeyed /* , Externalizable, SerializableWrite */ {
    ...
    protected boolean m_bArtEsp;
    protected boolean m_bNoMosIva;
    ...
    public void readValues(DataRead dr) throws BasicException {
        ...
        m_bArtEsp = dr.getBoolean(13).booleanValue();
        m_bNoMosIva = dr.getBoolean(14).booleanValue();
    }
    ...
    public final void setTaxID(String iTaxID) {
        m_TaxInfo.setID(iTaxID);
    }    
...
//    }
    ...
    public final boolean isArtEsp() {            
        return m_bArtEsp;
    }
    public final void setArtEsp(boolean bValue){            
    	m_bArtEsp = bValue;
    }
    
    /* 16/08/2017 */
    public final boolean noMosIva() {            
        return m_bNoMosIva;
    }
    public final void setNoMosIva(boolean bValue){            
    	m_bNoMosIva = bValue;
    }
}