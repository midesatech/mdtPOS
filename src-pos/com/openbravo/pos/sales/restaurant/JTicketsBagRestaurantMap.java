...
public class JTicketsBagRestaurantMap extends JTicketsBag {
            ...
            if (m_PlaceClipboard == null) {  
                ...
                if (customer == null) {
                    ...
                    if (ticket == null && !m_place.hasPeople()) {
                        ...
                        m_place.setPeople(true);  /*ACA SE ASIGNA LA IMAGEN */
    ...
    private void m_jbtnFacturarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jbtnRefreshActionPerformed

     
        
    }//GEN-LAST:event_m_jbtnRefreshActionPerformed
    
    private void setFacturarClosePlace(Place place, TicketInfo ticket) {
        m_PlaceCurrent = place;
        m_panelticket.setActiveTicket(ticket, m_PlaceCurrent.getName());
      //  m_panelticket.(ticket, m_PlaceCurrent.getName());
    }
